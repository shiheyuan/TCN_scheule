 ...
 * <li><a href="http://ecsl.cs.unr.edu/docs/techreports/gong/node3.html"> Sushil
 * J. Louis & Gong Li</a> (very clear explanatory material)</li>
 * <li><a href="http://www.tsp.gatech.edu www.tsp.gatech.edu"> <i>Travelling
...
public class TravellingSalesman extends Salesman {
	...
	public static final int[][] CITYARRAY = new int[][] { { 2, 4 }, { 7, 5 }, { 7, 11 }, { 8, 1 }, { 1, 6 }, { 5, 9 },
			{ 0, 11 } };
